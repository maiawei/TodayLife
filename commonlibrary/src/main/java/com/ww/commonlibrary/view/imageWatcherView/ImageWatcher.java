...
public class ImageWatcher extends FrameLayout implements GestureDetector.OnGestureListener, ViewPager.OnPageChangeListener {
    ...
    private static final int wxMode = 1;
    private static final int touTMode = 0;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        View view = getTouchTarget(idxView, (int) ev.getX(), (int) ev.getY());
    ...
    public boolean onSingleTapUp(MotionEvent e) {
        ...
        if (hadTapMessage) {
            ...
            mHandler.sendEmptyMessageDelayed(SINGLE_TAP_UP_CONFIRMED, 100);
        }
        return false;
    }
